...
store.dispatch(root.keyedSubState.get('_userId1_').foo.addTodo('hello'));
store.dispatch(root.keyedSubState.get('_userId1_').foo.addTodo('hello'));
store.dispatch(root.keyedSubState.get('_userId1_').bar.addTodo('hello'));
store.dispatch(root.keyedSubState.get('_userId2_').foo.addTodo('hello'));
